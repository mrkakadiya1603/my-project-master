...
const Pages = (props) => {
  ...
  return (
    <section className="bg-gray-100 pt-32 pb-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-center items-center gap-4">
          <div className="w-full sm:w-1/2 lg:w-1/3 mb-8">
            <div className="rounded-lg shadow-md overflow-hidden">
              <img className="w-full h-60 object-cover" alt="img" src={props.location.state.projectItem.image} />
            </div>
          </div>
          <div className="w-full sm:w-1/2 lg:w-2/3 max-w-xl">
            <h1 className="font-bold text-3xl text-black mb-4">{props.location.state.projectItem.name}</h1>
            <p className="text-gray-700 leading-relaxed text-lg">{props.location.state.projectItem.description}</p>
          </div>
        </div>
      </div>
    </section>
